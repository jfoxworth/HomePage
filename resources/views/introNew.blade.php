	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap nopadding">
				...
				<section id="section-testimonials" class="page-section section parallax full-screen nomargin dark" style="background-image: url('images/about/me-parallax.jpg'); padding: 200px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
